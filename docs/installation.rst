...
The sources for TimeSeriesX can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/carlculator/timeseriesx
.. _tarball: https://github.com/carlculator/timeseriesx/tarball/master
